...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      ...
      company: 'Global Tech',
      companyUrl: '#',
      quote: 'Professional team with great attention to detail. They delivered beyond our expectations with innovative solutions that transformed our business.',
      rating: 5,
      avatar: 'SJ',
    ...
    },
    {
      ...
      company: 'StartupX',
      companyUrl: '#',
      quote: 'Exceptional service and innovative solutions. They exceeded our expectations in every way and helped us scale rapidly.',
      rating: 5,
      avatar: 'MC',
    ...
    },
    {
      ...
      company: 'TechCorp',
      companyUrl: '#',
      quote: 'Outstanding collaboration and delivery. The team understood our vision perfectly and brought it to life with precision.',
      rating: 5,
      avatar: 'ER',
    ...
    },
    {
      ...
      company: 'InnovateHub',
      companyUrl: '#',
      quote: 'Incredible technical expertise and creativity. They turned our complex requirements into elegant, user-friendly solutions.',
      rating: 5,
      avatar: 'AH',
    ...
    },
    {
      ...
      company: 'FutureTech',
      companyUrl: '#',
      quote: 'Best development team we have worked with. Their attention to detail and commitment to quality is unmatched.',
      rating: 5,
      avatar: 'LW',
    ...
    },
    {
      ...
      company: 'CloudSoft',
      companyUrl: '#',
      quote: 'Exceptional quality and customer service. They went above and beyond to ensure our complete satisfaction.',
      rating: 5,
      avatar: 'DK',
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-20 px-4 sm:px-6 lg:px-8 min-h-screen flex flex-col items-center justify-center bg-base-100 relative overflow-hidden"
    >
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        <div className={`w-full flex justify-center lg:justify-start lg:pl-[15%] relative mb-16 transition-all duration-1000 delay-300 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
        ...
        <div className={`flex justify-center gap-3 mb-12 transition-all duration-1000 delay-500 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
        ...
        {/* Action Buttons */}
        <div className={`flex flex-col sm:flex-row gap-4 items-center justify-center transition-all duration-1000 delay-700 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
