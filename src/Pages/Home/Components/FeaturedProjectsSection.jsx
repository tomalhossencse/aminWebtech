...
const FeaturedProjectsSection = () => {
  ...
  const getFallbackProjects = () => [
    {
      ...
      description:
        "Ahbab.com.bd is a vibrant online shop for art supplies, crafted to help artists, students, and creative enthusiasts easily browse and...",
      category: "E-Commerce",
    ...
    },
    {
      ...
      description:
        "Patient management and appointment scheduling application designed to streamline hospital operations and improve patient experience.",
      category: "Mobile App",
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 lg:py-24 px-6 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-base-100 relative overflow-hidden"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-start">
        ...
        >
          ...
          <p className="text-lg text-base-content/70 max-w-xl leading-relaxed">
            Discover our latest work that showcases innovation, creativity, and
              ...
              <div className="card-body p-8 lg:p-10 relative">
                ...
                <ul className="space-y-6">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div
                        className={`flex-shrink-0 w-8 h-8 rounded-2xl ${feature.bgColor} flex items-center justify-center mt-1 shadow-lg group-hover/item:scale-110 group-hover/item:rotate-12 transition-all duration-300`}
                      >
                        <span
                          className={`material-icons ${feature.iconColor} text-sm group-hover/item:scale-110 transition-transform duration-300`}
                        >
                          {feature.icon}
                        </span>
                      </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative card bg-base-100 shadow-2xl border border-base-300/50 rounded-3xl overflow-hidden backdrop-blur-sm hover:shadow-purple-500/20 transition-all duration-500 h-full flex flex-col">
                ...
                <div
                  className={`h-72 w-full bg-gradient-to-br ${project.gradient} relative flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-700`}
                >
                  ...
                  <div className="absolute bottom-6 left-6 z-20">
                    <div
                      className={`badge ${project.categoryColor} backdrop-blur-md border-2 text-sm font-bold px-4 py-2 shadow-lg group-hover:scale-110 transition-all duration-300`}
                    >
      ...
      <div
        className={`flex justify-center mt-20 transition-all duration-1000 delay-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
