  ...
  const services = [
    {
      ...
      description: 'We build fast, secure, and visually stunning websites that convert visitors into customers.',
      icon: 'language',
    ...
    },
    {
      ...
      description: 'We create powerful mobile apps that deliver seamless user experiences.',
      icon: 'smartphone',
    ...
    },
    {
      ...
      description: 'Creative visual designs that capture your brand essence and engage your audience effectively.',
      icon: 'palette',
