...
const ResponsiveModal = ({ 
  ...
  const getSizeClasses = () => {
    switch (size) {
      ...
      case 'lg':
        return 'w-full sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 max-w-4xl';
      case 'xl':
        return 'w-full sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-10/12 max-w-6xl';
      case 'full':
        ...
        {(title || showCloseButton) && (
          ...
          `}>
            ...
            {showCloseButton && (
              <button
                onClick={onClose}
                className="ml-3 sm:ml-4 p-1.5 sm:p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors flex-shrink-0"
                title="Close"
              >
